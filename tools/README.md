...
- `generate-constellation.cjs` - Main tool script (constellation TLE generator)
- `generate-constellation-url.js` - Generate SatVis URLs with constellation data
- `generate-custom-url.js` - Generate SatVis URLs with custom TLE data
